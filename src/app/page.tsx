...
export default function Home() {
  return (
    <div style={{ width: '50%' }}>
      ...
      <h2 style={{ color: '#8c52ff', fontSize: '2em', margin: 0 }}>
        Serving to build your brand
      </h2>
      <p style={{ color: '#fff' }}>
        Here is a small short paragraph on what Serve Digital Media is all
        about. This is a short tag line that will draw attention and be an
        indication of what this site is for to users
      </p>
    </div>
  );
